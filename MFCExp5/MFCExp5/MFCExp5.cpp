...
BEGIN_MESSAGE_MAP(CMFCExp5App, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CMFCExp5App::OnAppAbout)
	// 基于文件的标准文档命令
...
CMFCExp5App::CMFCExp5App()
{
	...
	SetAppID(_T("MFCExp5.AppID.NoVersion"));

	// TODO: 在此处添加构造代码，
	// 将所有重要的初始化放置在 InitInstance 中
}

// 唯一的一个 CMFCExp5App 对象
